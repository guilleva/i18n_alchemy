module I18n
  module Alchemy
    ...
    base_proxy = if defined?(ActiveSupport::ProxyObject)
                   ActiveSupport::ProxyObject
                 elsif defined?(ActiveSupport::Deprecation::DeprecationProxy)
    ...
    class Proxy < base_proxy
      ...
      if ::RUBY_VERSION >= "2.7"
        ...
        ruby2_keywords :method_missing if RUBY_VERSION < "3.0"
      else
